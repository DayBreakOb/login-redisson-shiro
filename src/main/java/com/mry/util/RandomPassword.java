...
public class RandomPassword {
	 ...
	 */
	    ...
	    // 提供强度的构造方法
	    public RandomPassword(int strengthLevel, int length) {
	    ...
	    public static void main(String[] args) {
	        ...
	        RandomPassword password = new RandomPassword(4,32);
	        RandomPassword password2 = new RandomPassword(1, 16);
	        for (int i = 0; i < 10; i++) {
				try {
					System.out.println(password.getRandomPassword());
					System.out.println(password2.getRandomPassword());
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
