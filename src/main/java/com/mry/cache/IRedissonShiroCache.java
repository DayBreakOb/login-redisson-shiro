...
public class IRedissonShiroCache<K, V> implements Cache<K, V> {
    ...
    public IRedissonShiroCache(RMapCache<K, Object> mapCache, CacheConfig config, boolean allowNullValues) {
    ...
    public IRedissonShiroCache(RMap<K, Object> map, boolean allowNullValues) {
        this.map = map;
        this.allowNullValues = allowNullValues;
    }
